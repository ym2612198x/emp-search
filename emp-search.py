...
headers = [ {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0'},
            ...
            {'User-Agent': 'Mozilla/5.0 (X11; Linux i686; rv:79.0) Gecko/20100101 Firefox/79.0'},
            {'User-Agent': 'Mozilla/5.0 (Linux x86_64; rv:79.0) Gecko/20100101 Firefox/79.0'},
...
def searcher(engine, headers):
    ...
    if engine == "google":
        ...
        page = search_google(company, headers[random_number], num)
        names = soup_google(page)
        page = ""

        # subsequent pages search
        ...
        for num in range(1, 51, 10):
            time.sleep(random.uniform(0.5,7))
            random_number = random.randint(0, (len(headers) - 1))
            page = search_bing(company, headers[random_number], num)
            names = names + soup_bing(page)

    return names


bing_names = searcher("bing", headers)
google_names = searcher("google", headers)
